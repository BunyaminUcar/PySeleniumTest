...
class Test_Form():
    ...
    def test_multiple_selected_value_control(self):
        ...
        assert self.driver.find_element(
            By.XPATH, "//*[@id='_valuemultipleselect0']").text == "ms1"
        assert self.driver.find_element(
            By.XPATH, "//*[@id='_valuemultipleselect1']").text == "ms2"
        assert self.driver.find_element(
            By.XPATH, "//*[@id='_valuemultipleselect2']").text == "ms3"
        assert self.driver.find_element(
            By.XPATH, "//*[@id='_valuemultipleselect3']").text == "ms4"
